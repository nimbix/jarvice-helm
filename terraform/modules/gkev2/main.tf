...
resource "google_container_cluster" "jarvice" {
    ...
    ip_allocation_policy {
        cluster_ipv4_cidr_block = lookup(var.cluster.meta, "cluster_ipv4_cidr_block",  null)
        services_ipv4_cidr_block = lookup(var.cluster.meta, "services_ipv4_cidr_block",  null)
    }
