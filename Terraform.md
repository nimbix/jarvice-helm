...
The latest Terraform 1.x.x release is recommended.
...
service.  This hostname will be mapped to the static IP address issued by
the ingress controller.  The hostname will be formatted as such:
```bash
